      ...
      <div className="custom-container">
        <div className="py-20 flex flex-col gap-6 items-center justify-center max-lg:py-16">
          <div className="flex flex-col gap-1 items-center justify-center max-w-[500px] max-lg:max-w-full">
            ...
            <p className="font-onest text-greyLight text-lg max-lg:text-base">Наслаждайтесь новыми рецептами</p>
          </div>
          {isSubscribe ? (
            <div className="italic text-green">Вы подписаны на рассылку новых рецептов!</div>
          ) : (
            <>
              <SubscribeNewsletter />
              <PrivacyPolicyNote />
